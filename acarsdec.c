...
#if defined(WITH_RTL)||defined(WITH_UHD)
int gain = 1000;
int ppm = 0;
#endif
#ifdef WITH_AIR
...
#ifdef WITH_UHD
	fprintf(stderr,
			"-g gain\t\t: set usrp preamp gain in tenth of db (ie -g 9 for +9db). \n");
#endif
#ifdef WITH_AIR
	fprintf(stderr,
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "vafrso:t:g:Ap:n:N:l:c:i:f:U")) != EOF) {
